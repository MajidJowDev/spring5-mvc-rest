...
import static mjz.springframework.spring5mvcrest.controllers.v1.AbstractRestControllerTest.asJsonString;
...
//@WebMvcTest(controllers = {VendorController.class}) // this annotation brings up a small segment of the Spring Context (Just the web front-end)
...
//
//        given(vendorService.getAllVendors()).willReturn((List<VendorDTO>) vendorListDTO);
//
